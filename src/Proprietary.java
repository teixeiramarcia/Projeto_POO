...
public class Proprietary extends User implements Serializable {
     ...
     * @param rented    listagem de arrendamentos feitos até ao momento dos carros do proprietário
     */
    public Proprietary(String name, String email, String password, String address, LocalDate birthDate, String nif, List<Car> cars,
