...
public class RentAcarService {
    @FXML
    private CheckBox fuelCar;
    @FXML
    private CheckBox electricCar;
    @FXML
    private CheckBox hybridCar;
    @FXML
    private TextField destinationX;
    @FXML
    private TextField destinationY;
    @FXML
    private CheckBox closerCars;
    @FXML
    private CheckBox cheaperCars;
    @FXML
    private Button goBack;
    @FXML
    private TableView<Car> carsForChoice;
    ...
    public void handleMouseClick() throws IOException {
        ...
        Redirect.redirectTo(carsForChoice, "views/knowTripTime.fxml");
    }
}
