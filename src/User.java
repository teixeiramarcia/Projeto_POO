...
public class User implements Serializable {
     ...
     */
    public User(String name, String email, String password, String address, LocalDate birthDate, String nif) {
        this.name = name;
        this.email = email;
     ...
     */
    public List<Rental> rentalsBetweenDates(LocalDate initialDate, LocalDate finalDate) {
        List<Rental> rentals;
