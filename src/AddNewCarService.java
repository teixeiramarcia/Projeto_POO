...
public class AddNewCarService {
    ...
    @FXML
    private TextField mediumSpeed;
    @FXML
    private TextField priceKm;
    @FXML
    private TextField consumeKm;
    @FXML
    ...
    public void addCar() throws IOException {
        ...
        Redirect.redirectTo(ok, "views/carAdded.fxml");
    }

    public void goBack() throws IOException {
        Redirect.redirectTo(goBack, "views/homeProprietary.fxml");
    }
}
