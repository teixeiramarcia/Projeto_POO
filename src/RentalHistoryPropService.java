...
public class RentalHistoryPropService {
    ...
    public void close() throws IOException {
        Redirect.redirectTo(close, "views/homeProprietary.fxml");
    }
    ...
    public void searchButton() {
        ...
        Proprietary prop = (Proprietary) UMCarroJa.getService().getLoggedInUser(true);

        rentalBetDates = prop.rentalsBetweenDates(infLimitText, supLimitText);
