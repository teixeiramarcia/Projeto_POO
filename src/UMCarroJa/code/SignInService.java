...
public class SignInService {
    @FXML private CheckBox client;
    @FXML private CheckBox proprietary;
    ...
    public void signIn(){
        ...
        if(isClient){
            ...
            try {
                ...
                Redirect.redirectTo(name, "UMCarroJa/code/homeClient.fxml");
            ...
            try{
                ...
                Redirect.redirectTo(email, "UMCarroJa/code/homeProprietary.fxml");
            } catch (EmailAlreadyExistsException | IOException e){
                e.printStackTrace();
                Alert alert = new Alert(Alert.AlertType.ERROR, "Email " + e.getMessage() + " already exists", ButtonType.CLOSE);
                alert.showAndWait();
    ...
    public void goBack() throws IOException {
        Redirect.redirectTo(name, "UMCarroJa/View/logIn.fxml");
    }
