...
public class RentalHistoryService {
    ...
    @FXML private DatePicker infLimit;
    @FXML private DatePicker supLimit;
    @FXML private Button close;
    @FXML private TableView<Rental> rentalsBetweenDates;

    public void close() throws IOException {
        Redirect.redirectTo(close, "UMCarroJa/code/login.fxml");
    }
