...
public class KnowTripTimeService {
    ...
    @FXML private ChoiceBox<WeatherStatus> weatherState;
    @FXML private TextField drivingSkill;
    @FXML private Label estimateTime;
    ...
    public void ok() throws IOException {
        Redirect.redirectTo(estimateTime, "UMCarroJa/code/carRented.fxml");
    }
}