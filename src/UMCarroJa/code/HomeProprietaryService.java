...
public class HomeProprietaryService {
    @FXML private Label proprietaryName;
    @FXML private Button addNewCar;
    @FXML private Button rentalRequests;
    ...
    public void addCar() throws IOException{
        Redirect.redirectTo(addNewCar, "UMCarroJa/code/addNewCar.fxml");
    }

    public void rentalRequests() throws IOException{
        Redirect.redirectTo(rentalRequests, "UMCarroJa/code/rentalRequests.fxml");
    }
